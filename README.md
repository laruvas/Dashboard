...
- **Frontend:** https://dashboard-ebon-six-38.vercel.app
- **Backend API:** https://slottr-api.onrender.com

> ⏱ Первый запрос после паузы занимает ~30 секунд — Render free tier «засыпает» через 15 минут неактивности.
